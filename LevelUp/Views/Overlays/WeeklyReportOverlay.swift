    ...
    private var card: some View {
        VStack(spacing: 22) {
            ...
            LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible()),
                ...
                statCell("WORK", "\(report.workEntriesCount ?? (report.bvaActionsCount + report.paralaiLogsCount))", Theme.secondaryAccent)
                statCell("HOURS", String(format: "%.0fh", report.otherWorkHours), Theme.secondaryAccent)
